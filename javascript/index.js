...
const foodsound = new Audio ('MUSIC_SOUNDS/food.mp3');
const gameOverSound = new Audio ('MUSIC_SOUNDS/gameover.mp3');
const moveSound = new Audio ('MUSIC_SOUNDS/move.mp3');
const musicSound = new Audio ('MUSIC_SOUNDS/music.mp3');
let speed = 4;
let level = 0;
let previouslevel = 0;
let count = 0;
